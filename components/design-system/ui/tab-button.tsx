...
const tabButtonClassName =
  'inline-flex min-h-10 items-center justify-center gap-2 rounded-t-lg bg-transparent px-6 py-4 text-paragraph font-bold whitespace-nowrap text-foreground outline-none transition-colors hover:bg-muted aria-pressed:bg-muted data-[active]:bg-muted'
