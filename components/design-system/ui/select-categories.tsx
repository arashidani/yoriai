...
type SelectCategoriesProps = Omit<SelectPrimitive.Root.Props<string>, 'children' | 'items'> & {
  className?: string
  categories: Category[]
  placeholder?: string
}
...
function SelectCategories({
  ...
  const items = Object.fromEntries(categories.map((category) => [category.id, category.name]))
