...
const bookmarkButtonVariants = cva(
  'group inline-flex cursor-pointer items-center justify-center gap-1 rounded-full font-bold whitespace-nowrap text-muted-foreground outline-none aria-pressed:text-action-bookmark disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      size: {
